...
* no conflation of package-form and governing-pattern/package-relation roles: **Pack vs Kit vs Suite vs Family vs Bundle vs Cluster vs Profile vs Overlay vs Record vs Umbrella** are not interchanged, and the review states carrier status / governing-pattern/package relation explicitly instead of leaving it implicit or varying it for style,
...
rejects, or reclassifies one strongest applicable pattern body, strongest projection role,
...
* **Trigger class 1 — local recognition wording repair**
  ...
  strongest admissible entry / strongest projection role boundary.
...
* **Trigger class 2 — substantive entry-support change**
  ...
  strongest admissible entry / strongest projection role boundary, one changed local
...
* **Trigger class 5 — normative authority, kind, or durable-name change**
  ...
  `DRR`, `PCP-TERM`, and `PCP-MOD` are the lead decision or review loci as applicable;
...
* local wording repair that preserves the current first honest entry load,
  candidate-pattern set, strongest admissible entry / strongest projection role boundary,
...
1. **No workflow implication**
   ...
   artefact pipeline unless another strongest admissible entry or strongest projection role
   explicitly governs that semantics.

2. **Strongest-entry boundary preserved**
   Entry/index/lexical support roles do not redefine the strongest pattern body's `Problem`
   or `Solution`.
...
4. **No duplicate strong support role**
   ...
   support role outside the one strongest applicable pattern body or strongest projection role already
   named for the claim.
...
candidate-pattern force, strongest admissible entry / strongest projection role boundary,
...
Substantial discoverability changes leave one compact pattern-local note in the host
record.
That host-note may stop at one explicit rationale when the risk is already
controlled by strongest admissible entry / strongest projection role inspection, support-role
...
| --- | --- | --- |
| typo, grammar, formatting, meaning-preserving compression | no evidence run beyond ordinary review | current entry load, strongest admissible entry / strongest projection role boundary, and support role remains unchanged |
...
1. **PCP-ENTRY-E1 — cold-reader recognition or pattern-selection task**
   ...
   applicable pattern body or one admissible candidate-pattern set?
   ...
   4. the strongest admissible entry or strongest projection role.
   ```

2. **PCP-ENTRY-E2 — wrong-pattern / wrong-entry trap**
   Does the support role actively prevent the most tempting wrong pattern or wrong
   family?

3. **PCP-ENTRY-E3 — lexical query check**
   Does subject-domain phrasing retrieve the strongest admissible entry or strongest
   projection role without uncontrolled aliases?

4. **PCP-ENTRY-E4 — retrieval / `RAG` fixture**
   Does retrieval recover the strongest admissible entry or strongest projection role under
   exact-ID or keyword phrasing, under semantic paraphrase phrasing, and under
   projection-vs-strongest-entry ambiguity, while keeping retrieved support,
   source faithfulness, stale echoes, and post-rationalized citation-like
   support from being treated as the semantic authority source?
...
* and strongest-entry / projection separation recoverable as the amendment
  lands.
...
expected_strongest_entry_or_admissible_candidate_set
...
paraphrase retrieval, projection-vs-strongest-entry disambiguation,
...
3. **Packaging / governing-pattern/package-relation / shipping-fit.** Record this before any send-facing, landing-facing, monolith-facing, or governing-pattern/package-relation posture claim. Do not require it for ordinary local wording repairs.
