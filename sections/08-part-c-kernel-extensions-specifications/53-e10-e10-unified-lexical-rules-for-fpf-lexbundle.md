...
| **`Evaluation`**        | **Evaluation record / episteme**                    | D/S‑layer (epistemic episteme)              | ContextToken/DiscriminatorToken | `CalibrationEvaluation`                           | Using to name roles or methods.                                       |
...
* or one bounded `F.17` / `UTS` / `F.18` lexical-support record/view.
