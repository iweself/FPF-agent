...
**When user says:** What's the state of the art in X? / need a reusable search scaffold / portfolio of approaches

**What user gets:** Overview of schools/approaches, comparison table, reusable scaffold, what to shortlist
